...
for (i in 1:( p + 1)) {
  ...
  projections = t(solve(t(X_Vals) %*% X_Vals)%*% t(X_Vals) %*% y_Boston)
...
as more and more features or predictors are added, the less valued the house is in that area
...
yes because youre constantly adding more features
